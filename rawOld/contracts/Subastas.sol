...
/**
 * @title DayToks Auctions and Bids
...
contract Subastas{
   ...
   function createBid(uint tokenId, uint256 price) public returns (bool){
        ...
        bids[tokenId].highest_bid = price;
    ...
    // @notice Get the highest bid
    // @return amount of the highest bid
    function getHighestBid(uint tokenId) public view returns (uint256){
        return (bids[tokenId].highest_bid);
    }
